...
def extract_ozanciga_features_(checkpoint_path: str, *args, **kwargs):
    ...
    assert sha256.hexdigest() == '61dc3ce7273f4ecb2960c3df31b67e36c38e4f30d9622b42496f842752992117'
    ...
    return extract_features_(*args, **kwargs, model=model.cuda(), model_name='ozanciga-61dc3ce7')
